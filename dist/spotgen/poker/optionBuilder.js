...
exports.inferAnchorAction = inferAnchorAction;
exports.buildIntentUniverse = buildIntentUniverse;
exports.selectOptionsByDifficulty = selectOptionsByDifficulty;
exports.buildOptionsFromContext = buildOptionsFromContext;
exports.intentToSizing = intentToSizing;
exports.buildSpotOpts = buildSpotOpts;
// ═══════════════════════════════════════════════════════════════════════════
// CONSTANTS
// ═══════════════════════════════════════════════════════════════════════════
/**
 ...
 */
const INTENT_ORDER = ["check", "small", "large", "overbet"];
/**
 * Get the index of an intent in the canonical ordering
 */
function intentIndex(intent) {
 ...
 */
function inferAnchorAction(context) {
    if (context.checkDominant) {
        ...
        if ((context.leverage === "high" || context.leverage === "medium") &&
 ...
 */
function buildIntentUniverse(context) {
 ...
 */
function selectOptionsByDifficulty(universe, anchor, difficulty, reasons) {
    ...
    let lessAggressiveDistance;
    let moreAggressiveDistance;
    switch (difficulty) {
        case "easy":
    ...
    let opts = [lessAggressive, effectiveAnchor, moreAggressive];
 ...
 */
function findClosestInUniverse(target, universe) {
 ...
 */
function findOptionAtIndex(idx, universe) {
 ...
 */
function ensureThreeUniqueOptions(opts, universe, anchor, reasons) {
    ...
    if (unique.length < 3) {
        ...
        const fullOrder = ["check", "small", "large", "overbet"];
 ...
 */
function buildOptionsFromContext(input) {
 ...
 */
function intentToSizing(intent) {
    switch (intent) {
        case "check":
            return null;
        case "small":
 ...
 */
function buildSpotOpts(intents, pot) {
