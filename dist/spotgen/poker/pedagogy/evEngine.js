...
exports.computeEVs = computeEVs;
exports.getEVSpreadForDifficulty = getEVSpreadForDifficulty;
exports.validateEVs = validateEVs;
/**
 ...
 */
function computeEVs(bestIdx, difficulty, numOptions = 3) {
    if (numOptions !== 3) {
 ...
 * Exposed for testing.
 */
function getEVSpreadForDifficulty(difficulty) {
 ...
 * Exposed for testing.
 */
function validateEVs(ev, bestIdx) {
    if (ev.length !== 3)
        return false;
