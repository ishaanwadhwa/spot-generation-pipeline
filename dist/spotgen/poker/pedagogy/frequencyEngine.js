...
exports.assignFrequencies = assignFrequencies;
exports.getSpreadForDifficulty = getSpreadForDifficulty;
/**
 * Base frequency spreads by difficulty.
 * These are pedagogical, not solver-derived.
 */
const FREQUENCY_SPREADS = {
 ...
 */
function assignFrequencies(input) {
 ...
 * Exposed for testing.
 */
function getSpreadForDifficulty(difficulty) {
