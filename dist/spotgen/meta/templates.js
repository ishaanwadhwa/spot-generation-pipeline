 ...
 */
function getMetaTemplate(handIntent, heroClass, feats, turnType, bettingMode = "standard") {
    // Get base template
    let template;
    switch (handIntent) {
        case "made_value":
 ...
 */
function adjustForOverbetMode(baseTemplate, handIntent, heroClass) {
...
function getMadeValueTemplate(heroClass, feats, turnType) {
...
function getThinValueTemplate(feats, turnType) {
...
function getComboDrawTemplate(feats, turnType) {
...
function getDrawTemplate(feats, turnType) {
...
function getPureBluffTemplate(turnType) {
 ...
 */
function getGiveUpTemplate(turnType) {
    return {
